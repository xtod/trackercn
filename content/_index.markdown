...
[<img src="https://simpleicons.org/icons/github.svg" style="max-width:15%;min-width:40px;float:right;" alt="Github repo" />](https://github.com/xtod/trackercn.git)
...
https://tracker.guguan.us.kg:443/announce
...
sub `https://cf.trackerslist.com/all.txt`